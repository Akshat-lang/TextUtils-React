                ...
                <div className="accordion" id="accordionExample">
                    <div className="accordion-item">
                        ...
                        <div id="collapseOne" className="accordion-collapse collapse show" aria-labelledby="headingOne"
                            ...
                            <div className="accordion-body" style={{ backgroundColor: props.mode === 'light' ? 'white' : '#032845', color: props.mode === 'light' ? 'black' : 'white' }}>
                    ...
                    <div className="accordion-item">
                        ...
                        <div id="collapseTwo" className="accordion-collapse collapse" aria-labelledby="headingTwo"
                            ...
                            <div className="accordion-body"
                                ...
                                until the collapse plugin adds the appropriate classNamees that we use to style each element. These classNamees
